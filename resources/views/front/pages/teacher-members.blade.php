<h6 class="fw-bold pt-2 pb-0 text-danger text-uppercase">Teachers Members</h6>
            ...
            <?php if ($members) {
                foreach ($members as $member) { ?>
                    <div class="col-6 member-card" 
                        ...
                        <?php } else { ?>
                            <img src="<?= env('FRONT_ASSETS_URL') ?>images-omdayal/member-teacher.jpg" class="w-100 rounded-2" alt="<?= $member->name ?>" style="height: 153px;">
                        <?php } ?>
                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center" style="background-image:url(<?= env('FRONT_ASSETS_URL') ?>images-omdayal/profile-bg.jpg); background-repeat:no-repeat; width:100%;">
                                    ...
                                    <?php } else { ?>
                                        <img src="<?= env('FRONT_ASSETS_URL') ?>images-omdayal/member-teacher.jpg" alt="<?= $member->name ?>" style="border-radius:50%; width:150px; height:150px; border:1px solid #A40000;">
                                    <?php } ?>
