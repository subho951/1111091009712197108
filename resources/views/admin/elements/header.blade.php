...
<nav class="header-nav ms-auto">
  <ul class="d-flex align-items-center">
    ...
    <div>
      <a href="<?=url('/')?>" target="_blank" class="btn btn-sm" style="margin-right:10px; background-color: #000000; color: #b12323; font-weight: 600;"><i class="fa fa-globe"></i>  Visit Website</a>
    </div>
